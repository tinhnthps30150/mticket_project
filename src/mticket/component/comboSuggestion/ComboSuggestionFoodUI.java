...
public class ComboSuggestionFoodUI extends BasicComboBoxUI {

    private Color startColor = new Color(230,92,0);
    private Color endColor = new Color(249,212,35);
    ...
    public void installUI(JComponent jc) {
        ...
        comboBox.addPopupMenuListener(new PopupMenuListener() {
            ...
            public void popupMenuWillBecomeVisible(PopupMenuEvent pme) {
                arrowButton.setBackground(startColor);
            }

            @Override
            public void popupMenuWillBecomeInvisible(PopupMenuEvent pme) {
                arrowButton.setBackground(endColor);
            }
        ...
        txt.setSelectionColor(startColor);
    ...
    private class Border extends EmptyBorder {
        ...
        private Color focusColor = startColor;
