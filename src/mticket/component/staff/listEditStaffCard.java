 ...
 * @author HuyTinh
 */
public class listEditStaffCard extends javax.swing.JPanel {

    /**
     * Creates new form listEditMovieCard
     */
    public static listEditStaffCard lS;

    public listEditStaffCard() {
        initComponents();
        this.lS = this;
        ...
        jTextFieldSearchOption1.addOption(new SearchOption("Email", new ImageIcon(getClass().getResource("/mticket/image/email.png"))));
        jTextFieldSearchOption1.addOption(new SearchOption("CCCD", new ImageIcon(getClass().getResource("/mticket/image/id-card.png"))));
        setTransferHandler(new TransferHandler() {
            ...
            public boolean importData(JComponent comp, Transferable t) {
                try {
                    ...
                    initData(new staffDAO().selectAll());
    ...
    void search(String str) {
        if (str.equals("ID")) {
            initData(new staffDAO().selectBySql("select * from NhanVien where maNhanVien like ?", "%" + jTextFieldSearchOption1.getText() + "%"));
        } else if (str.equals("Name")) {
            initData(new staffDAO().selectBySql("select * from NhanVien where tenNhanVien like ?", "%" + jTextFieldSearchOption1.getText() + "%"));
        } else if (str.equals("Email")) {
            initData(new staffDAO().selectBySql("select * from NhanVien where taiKhoan like ?", "%" + jTextFieldSearchOption1.getText() + "%"));
        } else if (str.equals("CCCD")) {
            initData(new staffDAO().selectBySql("select * from NhanVien where Cccd like ?", "%" + jTextFieldSearchOption1.getText() + "%"));
        }
    }
