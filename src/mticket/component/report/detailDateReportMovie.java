 ...
 * @author HuyTinh
 */
public class detailDateReportMovie extends Transition {

    /**
     * Creates new form detailDateReportMovie
     */
    public detailDateReportMovie() {
        initComponents();
    }

    public void initDataDateInMonth(int month, String idMovie) {
        if (month > 0 && month < 13) {
            jPanel1.removeAll();
            ...
            do {
                dateReportMovieCard dRC = new dateReportMovieCard(firstDay.toString(), idMovie);
                jPanel1.add(dRC);
