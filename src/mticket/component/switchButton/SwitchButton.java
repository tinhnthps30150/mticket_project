package mticket.component.switchButton;
...
public class SwitchButton extends javax.swing.JPanel {
    ...
    private Color switchOffColor = Color.BLACK;
    ...
    private void init() {
        ...
        mticketUtils.setFont(lbOn, "Kodchasan-Medium.ttf", 12f);
        mticketUtils.setFont(lbOff, "Kodchasan-Medium.ttf", 12f);
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(lbOn, javax.swing.GroupLayout.DEFAULT_SIZE, 28, Short.MAX_VALUE)
            .addComponent(lbOff, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
    ...
    public String getLbOff() {
        return lbOff.getText();
    }

    public void setLbOff(String text) {
        this.lbOff.setText(text);
    }

    public String getLbOn() {
        return lbOn.getText();
    }

    public void setLbOn(String text) {
        this.lbOn.setText(text);
    }
