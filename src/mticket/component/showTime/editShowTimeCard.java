 ...
 * @author HuyTinh
 */
public class editShowTimeCard extends javax.swing.JPanel {
    ...
    public editShowTimeCard(ShowTime st) {
        initComponents();
        this.st = st;
        ...
        lblAnh.setText(st.getThoiGian());
        mticketUtils.setFont(lblAnh, "Kodchasan-Medium.ttf", 28f);
    }
    ...
    private void initComponents() {
        ...
        lblAnh.setBackground(new Color(0,0,0,25));
    ...
    private void btnSuakButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuakButton3ActionPerformed
        ...
        ((editShowTimeJDialog) sA).initData(this.st);
        sA.showAlert();
