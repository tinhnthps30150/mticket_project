 ...
 */
package mticket.component.showTime;
...
import mticket.view.editShowTimeJDialog;
 ...
 * @author HuyTinh
 */
public class listEditShowTimeCard extends javax.swing.JPanel {

    /**
     * Creates new form listEditMovieCard
     */
    public static listEditShowTimeCard lST;

    public listEditShowTimeCard() {
        initComponents();
        this.lST = this;
       setTransferHandler(new TransferHandler() {
            ...
            public boolean importData(JComponent comp, Transferable t) {
                try {
                    ...
                    initData(new showTimeDAO().selectAll());
    ...
    private void btnAddkButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddkButton3ActionPerformed
        ...
        SweetAlert sA = new editShowTimeJDialog(managerJFrame.mFrame, true);
        sA.showAlert();
